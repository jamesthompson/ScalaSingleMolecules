...
public class TiffDecoder {
    ...
    long OpenImageFileHeader() throws IOException {
        // Open 8-byte Image2D File Header at start of file.
        ...
        if (fitType == 11) {
            ...
            switch (fitType) {
                ...
                case 8:
                    ...
                    break; //Calibration.RODBARD2 (NIH Image2D)
            }
    ...
    FileInfo OpenIFD() throws IOException {
        // Get Image2D File Directory data
    ...
    public ArrayList<FileInfo> getTiffInfo() throws IOException {
        ...
        while (ifdOffset > 0L) {
            ...
            if (fi != null) {
                if (fi.nImages > 1) // ignore extra IFDs in ImageJ and NIH Image2D stacks
                {
                    ifdOffset = 0L;
                }
            }
